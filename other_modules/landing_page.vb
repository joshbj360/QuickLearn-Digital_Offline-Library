...
Public Class landing_page
    ...
    Private Sub Form1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        'MsgBox(get_selected_Drive_path(Get_Drive_Letter))

    End Sub

    'Private Sub Form1_Closing(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Disposed
        ...
        Else
            ...
            If DriveLetter <> "" Then
                ...
                If FilesFound.Count > 0 Then
                    ...
                    lbl_insertion.Text = "QuickLearn Drive Detected"

                Else
                    'MemoEdit1.Text = ""
                    lbl_insertion.Text = DriveLetter & " is not Quicklearn Drive"
    ...
    Private Sub Get_Drive_Letter_from_USBdrives()
        ...
        For Each USB_drive In Get_only_USB_drives()
           Dim FilesFound() As String = My.Computer.FileSystem.GetFiles(USB_drive.Trim,
                ...
                lbl_detection.Text = "QuickLearn Drive plugged in"
                Exit For
                Else
